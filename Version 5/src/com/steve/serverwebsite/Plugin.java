package com.steve.serverwebsite;
...
public class Plugin extends JavaPlugin {
	...
	public void onEnable() {
		getLogger().info("ServerWebsite v5 has been Enabled");
	...
	public void onDisable() {
		getLogger().info("ServerWebsite v5 is Shutting Down");
		saveConfig();
		getLogger().info("ServerWebsite v5 has been Disabled");
	}
